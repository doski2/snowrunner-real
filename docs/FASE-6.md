...
> **ARCHIVADO (jul 2026):** CE, `grabar_ce.py`, `cheat_engine/` y comparación MAE **no** son parte
> del proyecto activo. Ver **`CE-ARCHIVADO.md`**.
...
**No leemos el mapa .pak** (viscosidad, capas del autor). Leemos contacto Havok por rueda
(`TRUCK_WHEEL_MODEL`):
...
> Si `payload_kg` sigue en 0 con carga visual, la masa puede no reflejarse en el rigid body del
> chasis — ver `cheat_engine/README.md`.
...
1. [CE_RTTI_Reverse_Lookup](https://github.com/FindMuck/CE_RTTI_Reverse_Lookup) → clase

   `TRUCK_CONTROL@combine@@`

2. Actualizar `TRUCK_CONTROL_OFF` en `memoria_havok.py`, `TelemetryLogger.lua`,
...
Ver también: **`FASE-5.md`**, `cheat_engine/README.md`, `camiones/fleetstar/FASES.md`,
`camiones/mh9500/FASES.md`.
