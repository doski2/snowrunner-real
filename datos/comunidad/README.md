...
Hojas públicas importadas como JSON. **No sustituyen** el catálogo XML del `.pak`; complementan
diseño, masas, fricción, colores y sockets.
...
- Aliases: `cargo.json`, `wheels_comunidad.json`, `truck_colors.json`, `addon_colors.json`,
